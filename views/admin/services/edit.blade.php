...
<head>
    ...
    <title>Edit Service - Khan Hotel</title>
                        ...
                        <form action="{{ route('admin.services.update', $service) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" name="icon" value="{{ $service->icon }}" placeholder="fas fa-concierge-bell">
                                </div>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                @if($service->image)
                                <div>
                                    <img src="{{ asset('storage/' . $service->image) }}" class="img-thumbnail" style="height: 150px;">
                                </div>
                                @endif
